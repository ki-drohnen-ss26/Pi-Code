...
def log_profile(config: Config) -> None:
    ...
    # is not a detail, it is the difference between the params taking effect or not.
    log.warning("[PROFILE] VARIANT fw480dev-baro: ArduCopter 4.8.0-dev with a WORKING")
    log.warning("[PROFILE] barometer - 4.7+ parameter names in use (README_VARIANT.md)")
